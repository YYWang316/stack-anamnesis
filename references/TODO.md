...
**Remaining for GO-LIVE (live path still v2: `orchestrate.DEFAULT_TEMPLATE = crypto_research_v2.md`; writer brief is v2-flow).**
...
2. **Repoint `orchestrate.DEFAULT_TEMPLATE`** from `crypto_research_v2.md` → `crypto_research_v3.md` (do this WITH step 3 — not before, or the v2-flow writer brief mis-handles the v3 skeleton).
